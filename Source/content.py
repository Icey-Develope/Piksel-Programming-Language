...
class WrongFileTypeError(Error):
    def __init__(self, pos_start, pos_end):
        super().__init__(pos_start, pos_end, "Expected File Type: .pk ")
...
class BuiltInFunction(BaseFunction):
    ...
    def execute_sin(self, exec_ctx):
        i_a = exec_ctx.symbol_table.get("i_a")
        i_a = i_a.value
        _ = math.sin(i_a)
        return RTResult().success(Number(_))

    execute_sin.arg_names = ["i_a"]
...
BuiltInFunction.scrn = BuiltInFunction("screen")
BuiltInFunction.blit = BuiltInFunction("blit")
...
global_symbol_table.set("screen", BuiltInFunction.scrn)
global_symbol_table.set("blit", BuiltInFunction.blit)
